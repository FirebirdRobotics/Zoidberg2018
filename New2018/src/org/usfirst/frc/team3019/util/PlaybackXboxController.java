...
public class PlaybackXboxController extends XboxController {
	...
	public boolean getRawButton(int button) {
		/*if((button - 1) >= macroButtonValues.length) {
			System.out.println("Buttons" + ": " + macroButtonValues.length + " input: " + (button - 1));
		}*/
		return (playback) ? 
				macroButtonValues[button - 1]
				: super.getRawButton(button);
	}
